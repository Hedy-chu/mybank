...
interface IMyERC721 {
    ...
    function offlineApprove(address to,uint256 tokenId, uint256 price, uint8 v, bytes32 r, bytes32 s) external returns(bool);
}
contract NFTMarketV3 is OwnableUpgradeable, IERC721Receiver, EIP712Upgradeable, NoncesUpgradeable {
    ...
    function initialize(address nftAddr,address tokenAddr,string memory name,string memory version) initializer public {
